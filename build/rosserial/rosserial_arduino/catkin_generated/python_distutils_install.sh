...
echo_and_run cd "/home/ros_ws/src/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros_ws/src/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/ros_ws/build/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
