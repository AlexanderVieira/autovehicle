...
echo_and_run cd "/home/ros_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros_ws/src/rosserial/rosserial_vex_cortex/setup.py" \
     \
    build --build-base "/home/ros_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    --root="${DESTDIR-/}" \
