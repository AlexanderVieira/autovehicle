...
echo_and_run cd "/home/ros_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/ros_ws/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/ros_ws/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
